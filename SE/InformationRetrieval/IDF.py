...
class IDF:
	''' 
	from the filePath to read all the files. then calculate there DF TF IDF
	'''
...
#for itemList in index.wordList.keys():
#	print itemList+"\t:\t"+str(index.wordList[itemList])
#idf.getFiles()
#df = idf.buildDF()
#listTemp = idf.buildIDF()
#for [k,v,f] in listTemp:
#	print k+" : "+str(v)+' : '+str(f)