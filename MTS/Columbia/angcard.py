...
class Bing(MethodView):
    def get(self):
        ...
        url = 'http://api.microsofttranslator.com/v2/ajax.svc/TranslateArray2?appId=%22TMn3WlwPSZfoqCOHCavx_lwpJaGC-16xy8YQDRIOwxcd_VvR3fuI-aAZAom4cgJQi%22&texts=[%22%'\
          + urllib.quote(query) +'%22]&from=%22zh-chs%22&to=%22en%22&oncomplete=_mstc4&onerror=_mste4&loc=en&ctr=&'
